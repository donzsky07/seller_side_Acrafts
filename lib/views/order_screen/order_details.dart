...
import 'package:seller_side/views/order_screen/components/order_place.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: boldText(text: "Order Details", color: fontGrey, size: 18.0 ),
      ),
            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  boldText(text: "Shpping Address", color: purpleColor),
